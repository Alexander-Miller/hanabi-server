...
pub mod error_messages {
    ...
    pub const ALREADY_CONNECTED:             &'static str = "You are already connected.";
    pub const NOT_YET_CONNECTED:             &'static str = "You are not yet connected.";
